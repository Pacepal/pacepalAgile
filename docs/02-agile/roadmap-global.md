...
- `docs/02-agile/roles.md` + captura del tablero.
- `docs/01-requisitos/definicion-proyecto.md` (respuestas DI1).
- `docs/02-agile/backlog.md` con historias en formato tarjeta.

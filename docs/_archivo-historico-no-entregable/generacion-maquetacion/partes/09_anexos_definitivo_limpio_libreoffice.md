...
Pie sugerido: Figura C5. Wireframe de la landing page de PacePal — escritorio. Sprint 1 DIW.

[INSERTAR WIREFRAME 2 ESCRITORIO AQUÍ EN LIBREOFFICE]
Archivo: docs/03-diw/wireframes/wireframe-actividades-desktop.png
Pie sugerido: Wireframe del listado de actividades — escritorio. Sprint 1 DIW.
...
Pie sugerido: Figura C1. Logotipo principal de PacePal.
...
Pie sugerido: Figura C2. Paleta de color corporativa de PacePal.
...
Pie sugerido: Figura C3. Sistema tipográfico de PacePal.
...
Pie sugerido: Figura C4. Sistema de iconografía de PacePal basado en Bootstrap Icons.
...
El inventario siguiente recoge las figuras previstas para la maquetación final. Antes
de exportar a PDF se debe comprobar visualmente que todas las imágenes se insertan
correctamente desde LibreOffice.

---

**Bloque A — Planificación y organización**

| Código | Título              | Archivo                                                                | Dónde se cita             | Pie sugerido                                                            |
| ------ | ------------------- | ---------------------------------------------------------------------- | ------------------------- | ----------------------------------------------------------------------- |
...
Pie sugerido: Figura A1. Diagrama de Gantt de PacePal organizado por sprints y fase de cierre documental.

[INSERTAR FIGURA A2 AQUÍ EN LIBREOFFICE]
Archivo: docs/documentacion-final/figuras/Diagrama de casos de uso.png
Pie sugerido: Figura A2. Diagrama de casos de uso con los cuatro actores del sistema.

[INSERTAR FIGURA A3 AQUÍ EN LIBREOFFICE]
Archivo: docs/documentacion-final/figuras/Diagrama de clases simplificado.png
Pie sugerido: Figura A3. Diagrama de clases simplificado del dominio de PacePal.
...
Pie sugerido: Figura B1. Diagrama de componentes del cliente React y el backend PHP.

[INSERTAR FIGURA B2 AQUÍ EN LIBREOFFICE]
Archivo: docs/documentacion-final/figuras/Esquema de arquitectura general.png
Pie sugerido: Figura B2. Arquitectura general del proyecto: cliente React, API PHP y base de datos MySQL.

[INSERTAR FIGURA B3 AQUÍ EN LIBREOFFICE]
Archivo: docs/documentacion-final/figuras/Modelo relacional simplificado.png
Pie sugerido: Figura B3. Modelo relacional simplificado con las nueve entidades principales de PacePal.
...
[INSERTAR FIGURA C3 AQUÍ EN LIBREOFFICE]
Archivo: docs/03-diw/media/tipografiaIdentidadVisual.png
Pie sugerido: Figura C3. Sistema tipográfico de PacePal: fuente Inter en sus variantes de peso y tamaño.

[INSERTAR FIGURA C4 AQUÍ EN LIBREOFFICE]
Archivo: docs/03-diw/media/pacepal_iconografia.png
Pie sugerido: Figura C4. Iconografía de PacePal basada en Bootstrap Icons.
...
Pie sugerido: Figura C8. Esquema del sistema responsive modular de PacePal con hojas CSS independientes por sección.
...
Pie sugerido: Figura D1. Landing de PacePal en el cliente React. Captura de validación del Sprint 3.
...
Pie sugerido: Figura D2. Escaparate de productos de PacePal cargado desde la API. Sprint 3.
...
Pie sugerido: Figura D3. Buscador dinámico de productos con resultados filtrados sin recargar la página.

[INSERTAR FIGURA D4 AQUÍ EN LIBREOFFICE]
Archivo: docs/evidencias/dwec/sprint-3/Carrito-React.png
Pie sugerido: Figura D4. Carrito React con producto, cantidad y total calculado. Evidencia DWEC Sprint 3.

[INSERTAR FIGURA D5 AQUÍ EN LIBREOFFICE]
Archivo: docs/evidencias/dwec/sprint-3/Carrito_añadir_React.png
Pie sugerido: Figura D5. Confirmación de "Añadido al carrito" en la interfaz React de PacePal.
...
Pie sugerido: Figura D6. Pantalla de perfil de usuario autenticado en PacePal React.

[INSERTAR FIGURA D7 AQUÍ EN LIBREOFFICE]
Archivo: docs/documentacion-final/figuras/Flujo loginSesionLogOut.png
Pie sugerido: Figura D7. Diagrama del flujo completo de autenticación: login, sesión activa y logout.

[INSERTAR FIGURA D8 AQUÍ EN LIBREOFFICE]
Archivo: docs/documentacion-final/capturas-finales/02-react/react-panel-admin.png
Pie sugerido: Figura D8. Panel de administración de PacePal con acceso restringido a rol admin.
...
Pie sugerido: Figura E1. Diagrama del flujo del buscador dinámico AJAX de PacePal.

[INSERTAR FIGURA E2 AQUÍ EN LIBREOFFICE]
Archivo: docs/documentacion-final/figuras/Flujo carrito.png
Pie sugerido: Figura E2. Diagrama del flujo de gestión del carrito: añadir, modificar, eliminar y finalizar pedido.

[INSERTAR FIGURA E3 AQUÍ EN LIBREOFFICE]
Archivo: docs/evidencias/dwes/diagramaER.png
Pie sugerido: Figura E3. Diagrama entidad-relación de la base de datos de PacePal.

[INSERTAR FIGURA E4 AQUÍ EN LIBREOFFICE]
Archivo: docs/evidencias/dwes/postman1.png
Pie sugerido: Figura E4. Runner de Postman ejecutando la colección de PacePal con resultados de la API.

[INSERTAR FIGURA E5 AQUÍ EN LIBREOFFICE]
Archivo: docs/evidencias/dwes/postman2.png
Pie sugerido: Figura E5. Segunda evidencia de las pruebas de la colección Postman de PacePal.
...
Pie sugerido: Figura F1. Resultado Lighthouse sobre la landing de PacePal: puntuación 100 en accesibilidad.

[INSERTAR FIGURA F2 AQUÍ EN LIBREOFFICE]
Archivo: docs/evidencias/diw/sprint-2/wave-analisis.png
Pie sugerido: Figura F2. Resultado del análisis WAVE sobre la landing de PacePal: 0 errores en el alcance auditado.

[INSERTAR FIGURA F3 AQUÍ EN LIBREOFFICE]
Archivo: docs/evidencias/diw/sprint-2/WCAG_Contrast_Checker.png
Pie sugerido: Figura F3. Comprobación de contraste WCAG realizada durante la auditoría de accesibilidad DIW Sprint 2.
...
Pie sugerido: Figura F4. Foco visible por teclado en la interfaz de PacePal.
...
Pie sugerido: Figura F5. Botón de accesibilidad por voz en la interfaz de PacePal.
...
Pie sugerido: Figura G1. Panel de XAMPP operativo durante la validación del entorno local. Apache y MySQL activos.

[INSERTAR FIGURA G2 AQUÍ EN LIBREOFFICE]
Archivo: docs/evidencias/despliegue/sprint-3/03-phpmyadmin-bd-pacepal.png
Pie sugerido: Figura G2. phpMyAdmin mostrando la base de datos pacepal con sus tablas.

[INSERTAR FIGURA G3 AQUÍ EN LIBREOFFICE]
Archivo: docs/evidencias/despliegue/sprint-3/08-github-pages-publicacion-https.png
Pie sugerido: Figura G3. Cliente React de PacePal publicado en GitHub Pages con HTTPS.

[INSERTAR FIGURA G4 AQUÍ EN LIBREOFFICE]
Archivo: docs/evidencias/despliegue/sprint-3/05-api-session-localhost-admin.png
Pie sugerido: Figura G4. Respuesta JSON del endpoint /api/session con sesión de administrador activa en entorno local.

[INSERTAR FIGURA G5 AQUÍ EN LIBREOFFICE — 3 IMÁGENES SEGUIDAS]
Archivo 1: docs/documentacion-final/capturas-finales/03-responsive/responsive-desktop-landing.png
Archivo 2: docs/documentacion-final/capturas-finales/03-responsive/responsive-tablet-landing.png
Archivo 3: docs/documentacion-final/capturas-finales/03-responsive/responsive-mobile-landing.png
Pie sugerido: Figura G5. Comparativa responsive de la landing de PacePal en escritorio, tablet y móvil.

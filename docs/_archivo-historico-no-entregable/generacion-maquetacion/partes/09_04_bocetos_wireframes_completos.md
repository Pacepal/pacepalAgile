...
Los wireframes completos del proyecto se incorporan en este anexo como listado técnico
verificable. Corresponden al trabajo realizado durante el Sprint 1 del módulo DIW y están
almacenados en `docs/03-diw/wireframes/`. Son diseño planificado, no capturas del
producto final.

Los wireframes están disponibles en dos formatos por pantalla: escritorio y móvil. Esta
doble versión es evidencia del enfoque mobile-first adoptado desde el primer sprint.

---

## Wireframes desktop

> **[INSERTAR FIGURAS DE WIREFRAMES ESCRITORIO AQUÍ EN LIBREOFFICE]**
...
> **[INSERTAR FIGURAS DE WIREFRAMES MÓVIL AQUÍ EN LIBREOFFICE]**
> Insertar cada imagen individualmente con su pie de figura.
...
- La pantalla de registro y login no tiene wireframe en este directorio: se planificó
  directamente sobre el formulario durante el Sprint 1 de DWEC.
- Los wireframes son de baja-media fidelidad y muestran la estructura de contenidos y

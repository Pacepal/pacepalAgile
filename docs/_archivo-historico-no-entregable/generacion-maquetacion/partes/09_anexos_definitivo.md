...
| 9.4   | Bocetos y wireframes completos | Listado de wireframes desktop y mobile verificados |
...
verificable. El cuerpo principal de la memoria solo incorpora los bocetos más
...
> **[INSERTAR IMÁGENES DE WIREFRAMES ESCRITORIO AQUÍ EN LIBREOFFICE]**
> Insertar cada imagen individualmente con su pie de figura.
...
> **[INSERTAR IMÁGENES DE WIREFRAMES MÓVIL AQUÍ EN LIBREOFFICE]**
> Insertar cada imagen individualmente con su pie de figura.
...
### Wireframe representativo — landing escritorio

> **[INSERTAR FIGURA C5 AQUÍ EN LIBREOFFICE]**
> Archivo: `docs/03-diw/wireframes/wireframe-landing-desktop.png`
> _Figura C5. Wireframe de la landing page de PacePal en versión escritorio. Sprint 1 DIW._

### Wireframe representativo — landing móvil

> **[INSERTAR FIGURA C6 AQUÍ EN LIBREOFFICE]**
> Archivo: `docs/03-diw/wireframes/wireframe-landing-mobile.png`
> _Figura C6. Wireframe de la landing page de PacePal en versión móvil. Sprint 1 DIW._
...
La regla cromática aplicada es 60-30-10: 60 % color base neutro (blanco y gris claro),
30 % color de marca (verde oscuro en cabecera, pie y botones primarios), 10 % color de
acento (verde lima para destacados y CTAs).
...
- Formularios con `<label for>` asociado a cada campo y mensajes de error con
  `aria-describedby`.
...
| Media     | HU-07, HU-08, HU-14 a HU-16, HU-18 a HU-20, HU-22, HU-25                | ~46          |
| Baja      | HU-26                                                                   | 8            |
...
Inventario final de figuras para insertar en LibreOffice. Solo se incluyen archivos
verificados como existentes en el repositorio. Están agrupadas por bloque temático.
...
> **[INSERTAR FIGURAS A1, A2, A3 EN LIBREOFFICE EN ESTE BLOQUE]**
...
> **[INSERTAR FIGURAS B1, B2, B3 EN LIBREOFFICE EN ESTE BLOQUE]**
...
> **[INSERTAR FIGURAS C1–C8 EN LIBREOFFICE EN ESTE BLOQUE]**
...
> **[INSERTAR FIGURAS D1–D8 EN LIBREOFFICE EN ESTE BLOQUE]**
...
> **[INSERTAR FIGURAS E1–E5 EN LIBREOFFICE EN ESTE BLOQUE]**
...
> **[INSERTAR FIGURAS F1–F5 EN LIBREOFFICE EN ESTE BLOQUE]**
...
| G5     | Responsive comparativa | `docs/documentacion-final/capturas-finales/03-responsive/responsive-desktop-landing.png` + tablet + mobile | Sección 4.3 / 6 | Figura G5. Comparativa responsive de la landing en escritorio, tablet y móvil.          |

> **[INSERTAR FIGURAS G1–G5 EN LIBREOFFICE EN ESTE BLOQUE]**
>
> Para G5 insertar las tres imágenes seguidas con el mismo pie o como composición:
> `responsive-desktop-landing.png`, `responsive-tablet-landing.png`,
> `responsive-mobile-landing.png`

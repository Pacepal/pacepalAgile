...
Base de evidencias del bloque **Despliegue** para PacePal.
...
- `docs/evidencias/despliegue/sprint-3/05-api-session-localhost-admin.png`
...
- `docs/evidencias/despliegue/sprint-3/10-ruta-proyecto-htdocs.txt`
- `docs/evidencias/despliegue/sprint-3/11-permisos-proyecto-acl.txt`
- `docs/evidencias/despliegue/sprint-3/12-healthcheck-localhost.txt`

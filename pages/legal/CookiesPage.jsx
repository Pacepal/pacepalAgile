    ...
    <main>
      ...
      <section className="seccion-pagina">
        <div className="contenedor">
          <article className="legal-contenido">
            ...
            <h3>2.2 Cookie de consentimiento de PacePal</h3>
            <table className="table table-bordered">
              <thead>
                <tr>
                  <th>Nombre</th>
              ...
              <tbody>
                <tr>
                  <td>pacepal_cookie_consent</td>
                  <td>Técnica / Necesaria</td>
                  <td>
                    Registra la decisión de consentimiento del usuario en formato JSON.
                    Contiene los campos <code>necessary</code>, <code>analytics</code>, <code>preferences</code>,
                    <code>marketing</code>, <code>accepted_at</code> y <code>version</code>.
                  </td>
                  <td>6 meses</td>
                  <td>No</td>
                </tr>
            ...
            <p>
              Esta cookie guarda en un único valor JSON qué categorías ha aceptado el usuario, de modo que
              el banner no vuelva a mostrarse mientras exista una decisión registrada. Si se elimina desde
              el navegador, el banner vuelve a aparecer al recargar la web.
            </p>
            ...
            <p>Al visitar PacePal por primera vez, se muestra un banner de cookies donde puedes:</p>
            <ul>
            ...
            <p>Si deseas cambiar tu elección después, puedes hacerlo de dos formas:</p>
            <ul>
            ...
            <p className="legal-actualizacion">

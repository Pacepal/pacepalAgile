              ...
              <article className="tarjeta-pagina">
                ...
                <form id="formEditarPerfil" onSubmit={saveProfile}>
                  ...
                  <div className="acciones-pagina">
                    <button type="button" className="boton boton--volver" onClick={() => setEditing(false)}>
                      Cancelar
                    </button>
                    <button type="submit" className="boton boton--primario boton--accion">Guardar cambios</button>
                  </div>

...
const contactAudioMp3 = buildPublicAssetUrl('audio/pacepal-contacto.mp3');
const contactAudioOgg = buildPublicAssetUrl('audio/pacepal-contacto.ogg');
...
function validarPrivacidad(value) {
  if (!value) return 'Debes aceptar el aviso educativo y de privacidad.';
  return '';
}
...
function ContactPage() {
  ...
  function handleSubmit(event) {
    ...
    setMessage('Mensaje preparado correctamente. Esta versión todavía no realiza envíos reales.');
    setMessageType('ok');
  }
      ...
      <section className="seccion-pagina">
        <div className="contenedor contacto-contenido">
          <aside className="contacto-info" aria-labelledby="contacto-info-titulo">
            ...
            <p className="contacto-info__nota">
              Este formulario forma parte de la demo académica de PacePal y no realiza envíos reales.
            </p>
          </aside>
            ...
            <form onSubmit={handleSubmit} noValidate>
              ...
              <div className="contenedor-checkbox contacto-formulario__checkbox">
                ...
                <label htmlFor={fieldIds.privacidad}>
                  Acepto el uso educativo de este formulario y entiendo que esta demo no realiza envíos reales.
                </label>
              </div>
        ...
        <div className="contenedor">
          <section className="tarjeta contacto-audio" aria-labelledby="contacto-audio-titulo">
            <div className="contacto-audio__cabecera">
              <p className="kicker">UX e Interactividad</p>
              <h2 id="contacto-audio-titulo">La bienvenida a PacePal</h2>
              <p id="contacto-audio-descripcion">
                A veces, solo hace falta una voz amiga para empezar. Este pequeno detalle sonoro en nuestra pagina de
                contacto esta pensado para recibirte con cercania, rompiendo el hielo antes de que nos escribas.
              </p>
              <p>
                Queremos que sepas que cuentas con nosotros para resolver dudas, organizar tu proxima actividad desde
                la base y hacer que cada nueva ruta empiece con total tranquilidad y muchisima ilusion.
              </p>
            </div>

            <audio controls preload="metadata" className="contacto-audio__reproductor" aria-describedby="contacto-audio-descripcion">
              <source src={contactAudioMp3} type="audio/mpeg" />
              <source src={contactAudioOgg} type="audio/ogg" />
